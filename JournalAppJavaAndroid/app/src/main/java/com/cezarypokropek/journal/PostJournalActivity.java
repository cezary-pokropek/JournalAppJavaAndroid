...
public class PostJournalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton = findViewById(R.id.post_save_jounral_button);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.post_save_jounral_button:
                // save journal
                saveJournal();
                break;
    ...
    private void saveJournal() {
        ...
        if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(thoughts) && imageUri != null) {
            final StorageReference filepath = storageReference // .../journal_images/our_image.jpeg
                    ...
                    .child("my_image_" + Timestamp.now().getSeconds()); // e.g. my_image_39812739021
